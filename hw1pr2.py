...
Michelle Li
Feb. 3, 2020
Starter file for hw1pr2 of Big Data Spring 2020
...
if __name__ == '__main__':
	...
	"*** YOUR CODE HERE ***"
	X_space = np.linspace(-10,10,num=100).reshape(-1,1)
	y_space = (X_space * m_opt + b_opt).reshape(-1,1)
	"*** END YOUR CODE HERE ***"
	...
	"*** YOUR CODE HERE ***"
	y_pred_rand = (X_space * m_rand_opt + b_rand_opt).reshape(-1,1)
	"*** END YOUR CODE HERE ***"
